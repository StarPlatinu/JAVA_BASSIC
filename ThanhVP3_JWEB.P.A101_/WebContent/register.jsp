    ...
    <div class="register-table">
        ...
        <form action="register" method="post" class="register-box">
            <div class="w-75">
                ...
                <input name="username" id="username"type="text" placeholder="User name" minlength="3" maxlength="30" required>
                <label id="error_msg_email" style="color:red;display: block;margin: 10px 0px 0px 10px;"></label>
                <input name = "email" id="email" type="text" placeholder="E-mail" minlength="5" required>
                <label id="error_msg_password" style="color:red;display: block;margin: 10px 0px 0px 10px;"></label>
                <input name="password" id="password" type="password" placeholder="Password" minlength="8" maxlength="30" required>
                <label id="error_msg_re-password" style="color:red;display: block;margin: 10px 0px 0px 10px;"></label>
                <input name="repassword" id="re-password" type="password" placeholder="Re Password" minlength="8" maxlength="30" required>
            </div>
