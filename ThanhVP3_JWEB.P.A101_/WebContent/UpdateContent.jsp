      ...
      <div class="row w-100">
        ...
        <div class="col-sm-3 bg-light p-0 border">
          ...
          <div id="view-content-btn" class="border p-2 pl-4 text-info">
            ...
            ><span
              ><a href="viewcontent" id="view-content">
                View contents</a
              ></span
            >
          </div>
          ...
          <div id="form-content-btn" class="border p-2 pl-4 text-info">
            ...
            ><span>
              <a href="formcontent" id="form-content">
                Form-content</a
              ></span
            >
          </div>
        ...
        <div class="col-sm-9">
          <div id="add-content">
            <h2 class="pt-4">Update Content</h2>
            <hr class="border" />
            <div class="profile-form border rounded">
              ...
              <form action="update" method="post" id="profile-input" class="bg-white border p-3">
                ...
                <!-- Button  -->
                  ...
                  <button id="submit2" class="btn border" onclick="checkInput()">Submit Button</button>
