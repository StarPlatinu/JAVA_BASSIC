        ...
        <div class="row w-100">
          ...
          <div class="col-sm-3 bg-light p-0 border">
            ...
            <div id="view-content-btn" class="border p-2 pl-4 text-info">
              <i class="far fa-list-alt"></i><span><a href="view-content.jsp" id="view-content"> View contents</a></span>
            </div>

            <div id="form-content-btn" class="border p-2 pl-4 text-info">
              <i class="far fa-edit"></i><span> <a href="form-content.jsp" id="form-content"> Form-content</a></span>
            </div>
          </div> 
              ...
              <div class="profile-form border rounded">
                ...
                <form id="profile-input" class="bg-white border p-3">
                  <div class="input-firstname pb-2">
                    ...
                    <input class="p-1 border rounded" type="text" id="firstname" placeholder="Enter the first name" required minlength="3" maxlength="30">
                  </div>
                  <div class="input-lasttname pb-2">
                    <label id="error_msg_lastname" for=""><b> Last Name</b></label><br>
                    <input class="p-1 border rounded" type="text" id="lastname" placeholder="Enter the last name" required minlength="3" maxlength="30">
                  </div>
                  <div class="input-email pb-2">
                    <label for="" id="error_msg_email"><b> Email</b></label><br>
                    <input class="p-1 border-0 text-dark" type="text" id="email" placeholder="your_email@example.com">
                  </div>
                  <div class="input-Phonenumber pb-2">
                    <label for="F" id="error_msg_phone"><b> Phone</b></label><br>
                    <input class="p-1 border rounded" type="text" id="phone" placeholder="Enter your phone number" required minlength="9" maxlength="13">
                  </div>
                  ...
                  <!-- Button  -->
                  <br>
                    <div id="sumit1" class="btn  btn-light" onclick="checkInput()">Submit Button</div>
                    <button id="reset1" class="btn  btn-light" type="reset">Reset Button</button>
