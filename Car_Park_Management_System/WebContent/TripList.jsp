					...
					<div class="container p-5">
						...
						<div class="row">
							<table class="table table-bordered">
								...
								<tbody>
									<c:forEach items="${listPerPage}" var="trip">
										<tr>
											<td>${trip.tripId}</td>
											...
											<td><a href="updateTrip?tripId=${trip.tripId}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a> 
												<a href="deleteTrip?tripId=${trip.tripId}"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a> 	
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<ul class="pagination">
								...
								<c:forEach begin="${1}" end="${requestScope.num}" var="i">
									...
									<li class="page-item "><a class="page-link"
										href="tripList?data=${data}&&page=${i}">${i}</a></li>
								</c:forEach>
								<li class="page-item"><a class="page-link" href="#"
