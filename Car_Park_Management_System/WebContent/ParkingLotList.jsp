			...
			<div class="col-md-9 right-content border">
				<div class="container p-5">
					...
					<div class="row  p-2">
						...
						<div class="col-md-4">
							<form action="parkingList" method="post">
					...
					<div class="row">
						<table class="table table-bordered">
							...
							<tbody>
								<c:forEach items="${listPerPage}" var="parking">
									<tr>
										...
										<td>${parking.parkStatus}</td>
										<td>
								       <a href="updateParkingLot?parkId=${parking.parkId}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>&nbsp
                                       <a href="deleteParkinglot?parkId=${parking.parkId}"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>	
									    </td>
									</tr>
								</c:forEach>
						...
						<ul class="pagination">
							...
							<c:forEach begin="${1}" end="${requestScope.num}" var="i">
								...
								<li class="page-item "><a class="page-link"
									href="parkingList?data=${data}&&page=${i}">${i}</a></li>
							</c:forEach>
							<li class="page-item"><a class="page-link" href="#"
