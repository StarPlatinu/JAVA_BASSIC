						...
						<form action="addTicket" method="post">
							<table class="table1">
								<tr>
									...
									<td><input name="customer" class="form-control"
										type="text" placeholder="Enter customer name" min="3"
										maxlength="30" required="required"></td>
								</tr>
								<tr>
									<td><b>Booking time <span class="text-danger">(*)</span></b></td>
									<td><input name="time" class="form-control"
										type="time" required="required"></td>
								</tr>
								   <tr>
                                <td><b>Trip<span class="text-danger">(*)</span></b></td>
                                <td><select name = "trip" id="inputPlace" class="form-control">
                              ...
                              <option value="${trip.destination}">${trip.destination}</option>
                               ...
                               <tr>
                                ...
                                <td><select name = "place" id="inputPlace" class="form-control">
                                   <c:forEach items="${listTicket}" var="ticket">                           
                              <option value="${ticket.licensePlate}">${ticket.licensePlate}</option>
                             </c:forEach>
                                </select>
                          </td>
                            </tr>
