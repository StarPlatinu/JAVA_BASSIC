			...
			<div class="col-md-9 right-content border">
					<div class="container p-5">
						...
						<div class="row  p-2">
							...
							<div class="col-md-4">
								<form action="ticketList" method="post">
							...
							<div class="input-group mb-2 mr-sm-2">
								...
								<select class="select rounded-right border-info">
									<c:forEach items="${ticketlist}" var="t">
										<option value="">${t.licensePlate}</option>
									</c:forEach>
								</select>
						...
						<div class="row">
							<table class="table table-bordered">
								...
								<tbody>
									<c:forEach items="${listPerPage}" var="ticket">
										<tr>
											...
											<td><a href="deleteTicket?ticketId=${ticket.ticketId}"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
							...
							<ul class="pagination">
								...
								<c:forEach begin="${1}" end="${requestScope.num}" var="i">
									...
									<li class="page-item "><a class="page-link"
										href="ticketList?data=${data}&&page=${i}">${i}</a></li>
								</c:forEach>
								<li class="page-item"><a class="page-link" href="#"
