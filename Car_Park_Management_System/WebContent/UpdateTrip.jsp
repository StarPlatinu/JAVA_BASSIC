					...
					<div class="row">
						...
						<form action="updateTrip" method="post">
							...
							<tr>
									...
									<td><input name="tripId" class="form-control"
										type="text" placeholder="Enter TripId" min="3"
										maxlength="30" value="${tripu.tripId}" readonly ></td>
								</tr>
								<tr>
									<td><b>Destination<br>
										<span class="text-danger">(*)</span></b></td>
									<td><input name="destination" class="form-control"
										type="text" placeholder="Enter destination" min="3"
										maxlength="30" valur="${tripu.destination}"></td>
								</tr>
								<tr>
									<td><b>Departure time <span class="text-danger">(*)</span></b></td>
									<td><input name="departureTime" class="form-control"
										type="text" placeholder="--:-- --" min="3" maxlength="30"></td>
								</tr>
								<tr>
									<td><b>Driver<span class="text-danger">(*)</span></b></td>
									<td><input name="driver" class="form-control" type="text"
										placeholder="Enter driver" minlength="3" maxlength="30" value="${tripu.driver}"></td>
								</tr>
								<tr>
									<td><b>Car type <span class="text-danger">(*)</span></b></td>
									<td><input name="carType" class="form-control" type="text"
										placeholder="Enter car type" minlength="3" maxlength="30" value="${tripu.carType}"></td>
									</td>
								</tr>
								<tr>
									<td><b>Maximum online ticket <br>number <span
											class="text-danger">(*)</span></b></td>
									<td><input name="maxTicket" class="form-control"
										type="number" placeholder="Enter price" min="0" value="${tripu.maximumOnlineTicketNumber}"></td>
								</tr>
